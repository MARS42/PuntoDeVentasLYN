 ...
 * @author Robert
 */
public class OnlyLogin extends javax.swing.JFrame {

    /**
     * Creates new form OnlyLogin
     */
    public OnlyLogin() {
        initComponents();
        Init();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OnlyLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
